...
const ThemeModal: FC = () => {
	...
	return (
		<div className='dropdown dropdown-end'>
			...
			<ul
				tabIndex={1}
				className='dropdown-content bg-base-200 rounded-box border-2 border-base-100 z-1 w-52 p-3 mt-2 shadow-2xl shadow-neutral/20 max-h-[600px] overflow-y-auto'
			>
				<ThemeItems onThemeChange={handleThemeChange} currentTheme={selectedTheme} />
			</ul>
		</div>
	)
}
